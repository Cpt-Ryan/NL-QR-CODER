...
Partial Class Corners
    ...
    Private Sub InitializeComponent()
        ...
        Label3 = New Label()
        MaleLeg = New TextBox()
        FemaleLeg = New TextBox()
        PanelHeight = New TextBox()
        Label4 = New Label()
        Label5 = New Label()
        Label6 = New Label()
        Label7 = New Label()
        ...
        Controls.Add(FemaleLeg)
        Controls.Add(MaleLeg)
        Controls.Add(Label3)
        Controls.Add(Label2)
        Controls.Add(Label1)
        Name = "Corners"
    ...
    Friend WithEvents MaleLeg As TextBox
    Friend WithEvents FemaleLeg As TextBox
    ...
    Friend WithEvents FBCheckBox As CheckBox
